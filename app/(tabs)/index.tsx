...
export default function HomeScreen()
{
    ...
    {
        const filteredItms = mockItemData.filter((item) => (item.title.toLowerCase().includes(text.toLowerCase())));
        ...
        <LinearGradient colors={[colors.gradientStart, colors.gradientEnd]} style={styles.gradient}>
            <SafeAreaView style={styles.container}>
                ...
                <ScrollView style={styles.itemsContainer}>
                    {
                        filteredData.map((item, index) => (<ListItem key={index} index={index} item={item} togglePizzaSize={togglePizzaSize}/>))
                    }
                </ScrollView>
            </SafeAreaView>
        </LinearGradient>
