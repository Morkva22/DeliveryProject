...
export type Item = {
    ...
    type: string;
    title: string;
    image: any; // require(...) возвращает объект/число в RN
    oldPrice?: string;
    newPrice: string;
    size42?: string;
    selectedSize: number;
...
const baseMockItemData: Item[] = [
    ...
    },
    {
        ...
        size42: '$12.99',
        selectedSize: 32,
        description: 'Italian vegetarian pizza with tomatoes, mushrooms, peppers, onion, and black olives.',
    },
    {
    ...
    },
    {
        ...
        size42: '$11.99',
        selectedSize: 32,
        description: 'Italian pizza with tomatoes, mozzarella, mushrooms, ham, oregano.',
    },
    {
        ...
        size42: '$19.99',
        selectedSize: 32,
        description: 'Italian pizza with mozzarella, salmon, mussels, calamari, tomato, lemon, pesto sauce, oregano.',
    },
    {
    ...
    },
    {
        ...
        size42: '$12.99',
        selectedSize: 32,
        description: 'Italian pizza with pizza sauce, chicken, pineapple, tomato, hollandaise cheese, mozzarella.',
    },
    {
        ...
        size42: '$15.99',
        selectedSize: 32,
        description: 'Italian pizza with tomato sauce, mozzarella, chicken, corn, sweet chili sauce.',
    },
    {
        ...
        size42: '$18.99',
        selectedSize: 32,
        description: 'Italian pizza with blue, soft, cream and hard cheeses.',
    },
];
...
const baseMockOnEndReachedData: Item[] = [
    {
        ...
        size42: '$14.99',
        selectedSize: 32,
        description: 'Italian pizza with chicken breast, mozzarella, parmesan, quail eggs, tomatoes, iceberg, béchamel sauce.',
    },
    {
    ...
    },
    {
        ...
        size42: '$15.99',
        selectedSize: 32,
        description: 'Italian pizza with BBQ sauce, mozzarella, prosciutto, bacon, sausages, mushrooms, cucumber, olives.',
    },
    {
        ...
        size42: '$19.99',
        selectedSize: 32,
        description: 'Italian pizza with mozzarella, parmesan, Dor Blue, cheddar, feta and cream sauce.',
    },
    {
        ...
        size42: '$14.99',
        selectedSize: 32,
        description: 'Italian pizza with cream sauce, mozzarella, bacon, egg, parmesan, capers, cherry tomato.',
    },
];
...
export const mockVegetables = [
    { id: '1', title: 'Mushrooms', image: require('../../assets/images/pizzaToppings/vegetables/mushrooms.jpg'), price: '$1.29', weight: '50 g' },
    { id: '2', title: 'Arugula', image: require('../../assets/images/pizzaToppings/vegetables/arugula.jpg'), price: '$1.99', weight: '50 g' },
    { id: '3', title: 'Olives', image: require('../../assets/images/pizzaToppings/vegetables/olives.jpg'), price: '$1.10', weight: '50 g' },
    { id: '4', title: 'Pepper', image: require('../../assets/images/pizzaToppings/vegetables/peppers.jpg'), price: '$1.50', weight: '50 g' },
    { id: '5', title: 'Corn', image: require('../../assets/images/pizzaToppings/vegetables/corn.jpg'), price: '$1.25', weight: '50 g' },
    { id: '6', title: 'Cucumber', image: require('../../assets/images/pizzaToppings/vegetables/cucumber.jpg'), price: '$1.15', weight: '50 g' },
    { id: '7', title: 'Onion', image: require('../../assets/images/pizzaToppings/vegetables/onion.jpg'), price: '$0.99', weight: '50 g' },
];

export const mockMeats = [
    { id: '8', title: 'Bacon', image: require('../../assets/images/pizzaToppings/meats/bacon.jpg'), price: '$2.00', weight: '50 g' },
    { id: '9', title: 'Chicken', image: require('../../assets/images/pizzaToppings/meats/chicken.jpg'), price: '$1.40', weight: '50 g' },
    { id: '10', title: 'Ham', image: require('../../assets/images/pizzaToppings/meats/ham.jpg'), price: '$1.80', weight: '50 g' },
    { id: '11', title: 'Pepperoni', image: require('../../assets/images/pizzaToppings/meats/pepperoni.jpg'), price: '$1.70', weight: '50 g' },
    { id: '12', title: 'Salami', image: require('../../assets/images/pizzaToppings/meats/salami.jpg'), price: '$1.70', weight: '50 g' },
    { id: '13', title: 'Smoked sausage', image: require('../../assets/images/pizzaToppings/meats/smoked-sausage.jpg'), price: '$1.80', weight: '50 g' },
];
