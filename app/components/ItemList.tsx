...
const ListItem = ({ item, togglePizzaSize }: ItemListProps) => {
    ...
    const toggleWishItem = useOrderWishStore((state) => state.toggleWishItem);
    const isLiked = useOrderWishStore((state) => state.isItemLiked(item));
    const showToast = useToastStore((state) => state.showToast);

    const onItemBuy = (pressedItem: ItemType) => {
        const orderCandidate = {
            ...pressedItem,
            volume: String(pressedItem.selectedSize),
        } as OrderItem;
                    ...
                    <View style={styles.itemDetails}>
                        ...
                        <View style={styles.priceContainer}>
                            <Text style={styles.priceText}>
                                {item.selectedSize === 32 ? item.newPrice : item.size42}
                            </Text>
                        ...
                        <View style={styles.sizeSelector}>
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.sizeOption,
                                    item.selectedSize === 32 ? styles.selectedSize : null
                                ]}
                            >
                                {item.selectedSize === 32 ? (
                                    ...
                                    <Image
                                        source={require("../../assets/images/icons-diameter.png")}
                                        style={styles.sizeIcon}
                                    />
                                )}
                                <Text
                                    style={[
                                        styles.sizeText,
                                        item.selectedSize === 32 ? styles.selectedSizeText : null
                                    ]}
                                >
                                    32 cm
                                </Text>
                            ...
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.sizeOption,
                                    item.selectedSize === 42 ? styles.selectedSize : null
                                ]}
                            >
                                ...
                                <Text
                                    style={[
                                        styles.sizeText,
                                        item.selectedSize === 42 ? styles.selectedSizeText : null
                                    ]}
                                >
                                    42 cm
                                </Text>
                        ...
                        <Text style={styles.itemWeight}>
                            {item.selectedSize === 32 ? item.weight32 : item.weight42}
                        </Text>
                    </View>
